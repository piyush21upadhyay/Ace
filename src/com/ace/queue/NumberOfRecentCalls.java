...
public class NumberOfRecentCalls {
    ...
    private int ping(int t) {
        ...
        // Remove elements from the queue that are outside the 3000 milliseconds window
        while (queue.peek()<t - 3000){
            queue.poll();
        }

        // The size of the queue is the number of requests in the past 3000 milliseconds
        return queue.size();
    }
}
